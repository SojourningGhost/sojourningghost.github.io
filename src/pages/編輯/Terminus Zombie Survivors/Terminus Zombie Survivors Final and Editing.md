---
title: Terminus Zombie Survivors — final and editing
---

### Terminus: Zombie Survivors

Posted: **August 17th, 2024, 16:12**
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/N1BsafpY5yJk.png>)  
_Key provided for free by the developer._
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/NnkVMLyi3aML.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/4nAndGH7OY0X.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/pDPlnfXoTS1b.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/wVENgyf7Uh5M.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/OsQ5sxYMSxnF.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/sx0soLhDDQ8t.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/XMrXIXIwQd4j.png>)

  
They won’t let you in, but they will give you jobs you can do to build trust. These always seem to be fetch quests of some kind: getting them food, bags, etc. In exchange, they’ll lower their rates for general trade and let you ask for favors. The more trust you have, the bigger the favors you can request, like asking for food or improving your gear. Knowing where the fortified houses are can be the difference between winning and losing. According to the achievements you _can_ join a fortified house, but, like a number of other things in Terminus, it's rather vague on how to go about it, and it's probably quite a time investment.  
  

![Image](</編輯/Terminus Zombie Survivors/Attachments/4Vo33HwwOylt.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/z49dsiyIEfP3.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/pshb2iqSuEvq.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/dbn5LEFBHqKi.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/QPca8Gas0qdd.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/suxHQl27zUK3.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/idL6AMl7GQ59.png>)
...
![Image](</編輯/Terminus Zombie Survivors/Attachments/Yu6HSXaCKWIe.png>)
...
Posted: **August 17th, 2024, 21:30**

by **Editor**

_@Reviewer_  

> keeping warm and fed in this game is more than enough.

Unclear. Not sure if you mean complexity, difficulty, or something else.  

> Every time you level, you get to pick a new skill. Some of these will be for your occupation's specific skills, and some of these will be for skills you can learn from books you can find lying around.

Unclear. Are you picking new skills or leveling skills? Do skill books just make the skill available for selection on level up without confering a skill level themselves?  

> The trouble with trying to make a genuine tool is that they’re so expensive to craft you’ll often run across the genuine article long before you’d need to make one.

'Need to'? Should this be 'can'? Context seems to imply it, but I'm not sure.  

> There's an overall medicine level for everything you take.

No explanation; not sure what it means.  

> no but mi-gos.

??? Is this just a reference I'm not getting?  
  
Made lots of minor changes. You can throw the original version into a text comparison tool along with the BB code from the current version (viewable when editing) to see what changed. Original version: (see [[Terminus BBcode#1]])

---

### Terminus: Zombie Survivors

Posted: **August 17th, 2024, 22:03**

by **Reviewer**

> [Editor] wrote: [↑ August 17th, 2024, 21:30](./viewtopic.php?p=130320#p130320)
> 
> Unclear. Not sure if you mean complexity, difficulty, or something else.

Complexity and in-game mechanics. Terminus requires you to stay fed, hydrated, and warm. CDDA requires these as well, but on a far more complicated level. I should have made less comparisons.  

> [Editor] wrote: [↑ August 17th, 2024, 21:30](./viewtopic.php?p=130320#p130320)
> 
> Unclear. Are you picking new skills or leveling skills? Do skill books just make the skill available for selection on level up without confering a skill level themselves?

Both. The skills from books and skills on leveling up are the same. You pick from one of three when leveling up which I forgot to mention. The only time that isn't true is when you still have an occupational skill to level in which case it will always appear in one or more of the slots. Reading skill books is just another way to level up skills. The only other skills that don't appear on leveling up are the vehicle skills which are needed to escape the city which I also failed to mention and need to edit.  

> [Editor] wrote: [↑ August 17th, 2024, 21:30](./viewtopic.php?p=130320#p130320)
> 
> 'Need to'? Should this be 'can'? Context seems to imply it, but I'm not sure.

Context would imply you'd come across the tool long before you'd ever need to make one anyway.  

> [Editor] wrote: [↑ August 17th, 2024, 21:30](./viewtopic.php?p=130320#p130320)
> 
> No explanation; not sure what it means.

I wasn't clear enough and neither is the game. There's a "medicine level" and the only way I found that out is by a trait I unlocked that keeps track of all the drugs and vitamins you take. In a nutshell the more medications you take the closer you get to having a headache, then a severe headache, and then you faint for a certain amount of time. This stops you from abusing things like adrenaline shots to give yourself unlimited action points or healing yourself endlessly while under attack from zombies. I didn't explain this well enough.  
...
404 grammar not found, should say "but no Mi-Gos" this is a reference to a CDDA monster and can probably be cut completely.

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 06:14**

by **Editor**

_@Reviewer_ let me know when you've made the changes relevant to those points and I will do another editing pass.

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 08:14**

by **Reviewer**

> [Editor] wrote: [↑ August 18th, 2024, 06:14](./viewtopic.php?p=130458#p130458)
> 
> _@Reviewer_ let me know when you've made the changes relevant to those points and I will do another editing pass.

Alright, I've made the changes, give it another go over.

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 16:14**

by **Editor**

_@Reviewer_

> but you never need to worry about calorie counts, water freezing over, or burning the entire city down.

Probably should be clarified that you never need to worry about these mechanics because they don't exist. To me, 'need to' makes it sound as they though exist but are irrelevant whereas 'have to' would make it more obvious that they aren't part of the game.  

> You need these if you intend to escape the city, to say nothing of finding a boat or helicopter.

This makes it sound as though you need the aforementioned skills in order to find a boat or helicopter. It felt as though it would require too much rewriting from me to tackle it, but, if you want a suggestion, maybe something like, "You need these if you intend to escape the city; of course, you still have to actually find a boat or helicopter..."  
  
Made various minor edits, mostly removing extraneous words and adding accidentally'd words.  
  
Previous version: (see [[Terminus BBcode#2]])

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 16:32**

by **Reviewer**

_@Editor_ 
  
Edits made, things clarified, calories removed, review put on a diet.

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 16:35**

by **Reviewer**

_@Editor_ 
  
Just noticed a mistake in the edits, quests in fortified houses are not timed.

---

### Terminus: Zombie Survivors

Posted: **August 18th, 2024, 17:06**

by **Reviewer**

_@Admin_ I think we're good to go. _@Editor_ edited and approved.

---

### Terminus: Zombie Survivors

Posted: **August 19th, 2024, 01:04**

by **Admin**

No mention of the key being provided by the developer.

---

### Terminus: Zombie Survivors

Posted: **August 19th, 2024, 01:13**

by **Admin**

I added a logo, made note of the key, added a steam link at the bottom, and centered the images. Going to let _@Editor_ give my edits a quick once over then I'll publish it.

---

### Terminus: Zombie Survivors

Posted: **August 19th, 2024, 04:21**

by **Editor**

For some reason align tags eat the empty lines around them, so I added extras to maintain the old spacing and italicized the note about the key. It should be good to publish now _@Admin_.
